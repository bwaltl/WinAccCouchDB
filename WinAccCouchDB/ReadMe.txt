========================================================================
    DYNAMIC LINK LIBRARY: WinAccCouchDB-Projektübersicht
========================================================================

Diese WinAccCouchDB-DLL wurde vom Anwendungs-Assistenten für Sie 
erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die WinAccCouchDB-Anwendung besteht.


WinAccCouchDB.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen WinAccCouchDB.pch sowie eine vorkompilierte 
